...
def main():
    fig, ax = plt.subplots(nrows=4, ncols=2, sharex='col', layout='constrained', figsize=(6,4))
    f = 17e3
    amp = 25
    ...
    ax[0,0].text(0.5, 1.05, 'Time domain', transform=ax[0,0].transAxes, horizontalalignment='center')
    ...
    ax[0,1].text(0.5, 1.05, 'Frequency domain', transform=ax[0,1].transAxes, horizontalalignment='center')

    for i, r in enumerate(ax):
        for j, _ in enumerate(r):
            ax[i, j].set_yticks([])

    fig.savefig('/Users/Brad/Library/CloudStorage/GoogleDrive-bdprice@ucsb.edu/My Drive/Research/Misc./Conferences/RMC2023/deconvolve.png', dpi=1000)
    f.savefig('/Users/Brad/Library/CloudStorage/GoogleDrive-bdprice@ucsb.edu/My Drive/Research/Misc./Conferences/RMC2023/slowscan.png', dpi=500)
