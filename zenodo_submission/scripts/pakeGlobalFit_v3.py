...
# N414Q setting -- fits/profile_ci_bounds.txt.
...
if __name__ == "__main__":
    ...
    # PLOT_CI_BANDS reads its CI table from next to broadened_f, so this
    # automatically tracks whichever dataset N414Q/sys.argv selected.
    CI_BOUNDS_FILE = Path(broadened_f).parent / "fits" / "profile_ci_bounds.txt"
    ...
    _skip_fitting = SKIP_TO_EMCEE or PROFILE_TAU or REPLOT_FROM_COMPARISON or RUN_BOOTSTRAP or RUN_MULTISTART or RUN_PROFILE_MATRIX or PROFILE_TOTAL_UNFOLDED or REPLOT_PROFILE_MATRIX or REPLOT_TAU_PRIOR or PLOT_CI_BANDS
