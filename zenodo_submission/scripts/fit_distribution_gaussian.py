...
DATA_DIR = Path(__file__).parent.parent / "data" / "md_distributions"
...
# Output figures/fit results are written alongside the input data.
...
def main():
    ...
    out_path = OUTPUT_DIR / (CSV_PATH.stem + "_gaussian_fits.txt")
    ...
    nolabel_out_path = OUTPUT_DIR / (CSV_PATH_NOLABEL.stem + "_gaussian_fits.txt")
