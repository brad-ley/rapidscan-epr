...
if __name__ == "__main__":
    filename = "/Users/Brad/Library/CloudStorage/GoogleDrive-bdprice@ucsb.edu/My Drive/Research/Data/2024/4/10/filter freqs/unfiltered/106mA_23.6kHz_acq10s_25000avgs.dat"
    main(filename)
    plt.show()
